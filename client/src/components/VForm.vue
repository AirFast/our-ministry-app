...
<template>
  <form class="relative w-full max-w-md px-12 pt-8 pb-10 rounded-md ring-1 ring-indigo-500/5 shadow-md bg-slate-50 dark:bg-slate-800">
    <Transition name="error-fade">
      <p v-if="error" class="absolute -top-20 left-0 w-full text-sm text-center text-rose-500 px-10 py-4 rounded-md border border-rose-200 duration-100 dark:border-rose-500">{{ t(`form.validation.${error}`) }}</p>
    </Transition>
